...
import me.sat7.dynamicshop.utilities.MySQL;
...
public final class DynamicShop extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        if(Bukkit.getPluginManager().isPluginEnabled("LuckPerms") == true) {
            Bukkit.getConsoleSender().sendMessage("§e[§9DynamicShops§e] §aLuckPerms Detected. Initializing setup.");
            setupLuckPerms();
    ...
    public void setupLuckPerms() {
        ...
        if (provider != null) {
            ...
            Bukkit.getConsoleSender().sendMessage("§e[§9DynamicShop§e] §aLuckPerms got provider successfully.");
        }
    }
    // 볼트 이코노미 초기화
