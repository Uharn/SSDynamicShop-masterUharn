...
//                        }
    ...
    public static void configSetup(DynamicShop dynamicShop) {
        ...
        //MYSQL
        dynamicShop.getConfig().set("host", dynamicShop.getConfig().getString("host"));
        dynamicShop.getConfig().set("port", dynamicShop.getConfig().getInt("port"));
        dynamicShop.getConfig().set("database", dynamicShop.getConfig().getString("database"));
        dynamicShop.getConfig().set("username", dynamicShop.getConfig().getString("username"));
        dynamicShop.getConfig().set("password", dynamicShop.getConfig().getString("password"));
        dynamicShop.getConfig().set("params", dynamicShop.getConfig().getString("params"));
        dynamicShop.getConfig().set("player_data", dynamicShop.getConfig().getString("player_data"));
